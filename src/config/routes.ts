...
export const routeRecords: RouteRecordRaw[] = [
  ...
  { path: '/tasks', name: 'tasks', component: () => import('../views/TaskCenterView.vue'), meta: { title: '任务中心', menu: true, groupIcon: 'list', order: 2 } satisfies AppRouteMeta },
  { path: '/apps', name: 'apps', component: () => import('../views/ApplicationCenterView.vue'), meta: { title: '应用中心', menu: true, groupIcon: 'apps', order: 3 } satisfies AppRouteMeta },
  { path: '/business-map', name: 'business-map', component: () => import('../views/BusinessMapView.vue'), meta: { title: '经营地图', menu: true, groupIcon: 'file', order: 4 } satisfies AppRouteMeta },
